...
const (
	...
	// TODO: Remove MsgWarnUpdateOutdatedHash before release v2.9.0
	MsgWarnUpdateOutdatedHash = "{HORUSEC_CLI} UPDATE HASH '%s' TO '%s'"

	// TODO: Remove MsgWarnAnalysisContainsOutdatedHash before release v2.9.0
	MsgWarnAnalysisContainsOutdatedHash = "{HORUSEC_CLI} YOUR CONFIGURATION FILE CONTAINS SOME HASHES THAT WILL NO " +
		"LONGER BE VALID AS OF v2.9.0 IS RELEASED. PLEASE UPDATE YOUR CONFIGURATION FILE WITH THE FOLLOWING HASHES:"
)
